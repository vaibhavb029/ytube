...
if($nextken == '0' ){
 ...
 $link = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyA7p42Or0-0fg7r3K1828qeWNoJ06teneM&channelId=".$_POST["channelid"]."&part=snippet,id&order=date&maxResults=".$_POST["limit"]."";
	
}else{
	
	//echo"<pre>";print_r("hi");exit();
$link= "https://www.googleapis.com/youtube/v3/search?key=AIzaSyA7p42Or0-0fg7r3K1828qeWNoJ06teneM&channelId=".$_POST["channelid"]."&part=snippet,id&order=date&maxResults=".$_POST["limit"]."&pageToken=".$nextken."";
