...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <?php $link = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyCJSBh5QOBXQmGUQp_5VgFFIjvUMDMYyMw&part=snippet&type=channel&q=microsoft&maxResults=50";
	...
	echo'<a href="videolist.php?channelId='.$rows['id']['channelId'].'"><img src="'.$rows['snippet']['thumbnails']['medium']['url'].'" class="img-circle"/></a>';
