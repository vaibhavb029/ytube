...
.widget_popular_videos{margin-top:30px;}
h5 {
    display: -webkit-box;
    max-height: 3.2rem;
...
<div class="container">
            ...
            <div class="row" id="widget_popular_videos">
               <!-- <div class="col-sm-7 feature_post">
                    <div class="media feature_post_inner">
                        <div class="media-left feature_img"><a href="single-video.html"><img src="images/large-video-2.jpg" alt=""><span class="duration">17:30</span></a></div>
                ...
                <div class="col-sm-12 other_posts widget widget_popular_videos"> 
                    <div class="col-md-6 media-left"><a href="single-video.html"><img data-lazy-src="images/large-video-2.jpg" data-size="1024:677"></a></div>
                    ...
                    <div class="col-sm-12 other_posts widget widget_popular_videos">
                    <div class="col-md-6 media-left"><a href="single-video.html"><img src="images/large-video-2.jpg" width="525" alt=""></a></div>
...
$(function(){
    $('#widget_popular_videos').DrLazyload();
	//$.DrLazyload();
});
</script>
